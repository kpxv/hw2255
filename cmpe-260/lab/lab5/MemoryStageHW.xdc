...
set_property PACKAGE_PIN W7 [get_ports {Seven_Seg_Digit[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Seven_Seg_Digit[0]}]
set_property PACKAGE_PIN W6 [get_ports {Seven_Seg_Digit[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Seven_Seg_Digit[1]}]
set_property PACKAGE_PIN U8 [get_ports {Seven_Seg_Digit[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Seven_Seg_Digit[2]}]
set_property PACKAGE_PIN V8 [get_ports {Seven_Seg_Digit[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Seven_Seg_Digit[3]}]
set_property PACKAGE_PIN U5 [get_ports {Seven_Seg_Digit[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Seven_Seg_Digit[4]}]
set_property PACKAGE_PIN V5 [get_ports {Seven_Seg_Digit[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Seven_Seg_Digit[5]}]
set_property PACKAGE_PIN U7 [get_ports {Seven_Seg_Digit[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Seven_Seg_Digit[6]}]

#set_property PACKAGE_PIN V7 [get_ports dp]
#	set_property IOSTANDARD LVCMOS33 [get_ports dp]

set_property PACKAGE_PIN U2 [get_ports {Active_Digit[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Active_Digit[0]}]
set_property PACKAGE_PIN U4 [get_ports {Active_Digit[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Active_Digit[1]}]
set_property PACKAGE_PIN V4 [get_ports {Active_Digit[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Active_Digit[2]}]
set_property PACKAGE_PIN W4 [get_ports {Active_Digit[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Active_Digit[3]}]
