...
\begin{enumerate}
    \item \inputminted{vhdl}{assets/q1.vhdl}
    \item \inputminted{vhdl}{assets/q2.vhdl}
	...
	\item Truth table:
      ...
      \item Encoder:
          ...
          \inputminted{vhdl}{assets/q5.vhdl}

          Testbench:

          \inputminted{vhdl}{assets/q5-tb.vhdl}
      ...
      \item 
          \begin{enumerate}
              \item \texttt{out <= data and (others => sel)}
              \item \texttt{for i in range'data loop out(i) <= data(i) when sel else '0'; end loop;}
              \item \texttt{for i in range'data loop with sel select out(i) <= data(i) when sel, '0' when others; end loop;}
          \end{enumerate}
\end{enumerate}
