/***************************************************************/
/* Definitions for module to support UART0 I/O with interrupts */
/* R. W. Melton                                                */
/* 10/12/2023                                                  */
/*-------------------------------------------------------------*/
/* Revision history:                                           */
/* 10/12/2023 Added check for MKL46Z4.h include                */
/* 10/14/2021 Added module #define                             */
/* 6/22/2015 Creation                                          */
/***************************************************************/
...
/*------------------------------------------------------------*/
#define NVIC_ICPR_UART0_MASK (1 << UART0_IRQ_NUMBER)
/*------------------------------------------------------------*/
/* NVIC_IPR0-NVIC_IPR7                                        */
/* 2-bit priority:  0 = highest; 3 = lowest                   */
/*------------------------------------------------------------*/
#define UART0_IRQ_PRIORITY (3)
#define UART0_IPR_REGISTER (UART0_IRQ_NUMBER >> 2)
#define NVIC_IPR_UART0_MASK \
                      (3 << (((UART0_IRQ_NUMBER & 3) << 3) + 6))
/*------------------------------------------------------------*/
/* NVIC_ISER                                                  */
...
/* 12:UART0 IRQ mask                                          */
/*------------------------------------------------------------*/
#define NVIC_ISER_UART0_MASK (1 << UART0_IRQ_NUMBER)
/*------------------------------------------------------------*/
