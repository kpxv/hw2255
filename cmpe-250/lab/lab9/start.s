...
.set CPU_XTAL_CLK_HZ       ,  32768
// Slow internal oscillator frequency (Hz)
.set CPU_INT_SLOW_CLK_HZ   ,  32768
// Fast internal oscillator frequency (Hz)
.set CPU_INT_FAST_CLK_HZ   ,  4000000
// Default system clock frequency (Hz)
.set DEFAULT_SYSTEM_CLOCK  ,  47972352
// ---------------------------------------------------------------
...
.set MCG_C1_FLL_DIV1_IRCLKEXTSTOP  ,  MCG_C1_IRCLKEN_MASK
// ---------------------------------------------------------------
...
.set MCG_C2_LF_EREFOSC  ,  MCG_C2_EREFS0_MASK
// ---------------------------------------------------------------
...
.set MCG_C4_DCO_25PMAX_MID  ,  (MCG_C4_DMX32_MASK | (1 << MCG_C4_DRST_DRS_SHIFT))
// ---------------------------------------------------------------
// Port A
.set PORT_PCR_SET_PTA3_EXTAL  ,  (PORT_PCR_ISF_MASK | PORT_PCR_MUX_SELECT_0_MASK)
.set PORT_PCR_SET_PTA4_XTAL   ,  (PORT_PCR_ISF_MASK | PORT_PCR_MUX_SELECT_0_MASK)
// ---------------------------------------------------------------
// OSC0_CR
...
.set OSC0_CR_ERCLK_STOP_NOLOAD  , OSC_CR_ERCLKEN_MASK
// ---------------------------------------------------------------
// SIM_CLKDIV1
...
//              :divide by OUTDIV4 + 1
.set SIM_CLKDIV1_COREDIV1_BUSDIV2  ,  (1 << SIM_CLKDIV1_OUTDIV4_SHIFT)
// ---------------------------------------------------------------
// SIM_COPC
...
.byte     FCF_BACKDOOR_KEY6,FCF_BACKDOOR_KEY7
