...
#define ADC0_CFG1_LP_LONG_SGL10_3MHZ                                        \
	(ADC_CFG1_ADLPC_MASK | (ADC0_CFG1_ADIV_BY2 << ADC_CFG1_ADIV_SHIFT) |    \
	 ADC_CFG1_ADLSMP_MASK | (ADC0_CFG1_MODE_SGL10 << ADC_CFG1_MODE_SHIFT) | \
...
#define ADC0_SC3_CAL (ADC_SC3_CAL_MASK | ADC_SC3_AVGE_MASK | ADC_SC3_AVGS_MASK)
/*-------------------------------------------------------------*/
/* DAC */
...
#define SET_PTB7_TPM0_CH2_OUT (PORT_PCR_ISF_MASK | PTB7_MUX_TPM0_CH2_OUT)
/*-------------------------------------------------------*/
/* SIM_SOPT2                                             */
...
#define TPM_SC_CLK_DIV16 \
	((TPM_SC_CMOD_CLK << TPM_SC_CMOD_SHIFT) | TPM_SC_PS_DIV16)
