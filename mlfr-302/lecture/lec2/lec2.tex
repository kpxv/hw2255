...
\begin{enumerate}
	...
	\item \textbf{Hugging Face}
	      ...
	      Il est société qui crée des outils et des bibliothèques pour aider au
	      apprentissage automatique. Au début, il créait un agent
	      conversationnel qui est ciblé les jeunes, mais maintent il creé des
	      outils.

	\item \textbf{Genomines:}

	      Il est un startup qui est très jeune. Il cherche un Directeur Géneral
	      Commercial. La société souhaite remettre l'exploitation minière
	      tradionnelle avec des plantes spécial. Ce n'est pas clair s'il a
          commencé — son site internet est très petit.
